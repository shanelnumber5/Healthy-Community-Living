	...
	foreach ($args['actions'] as $item) {
		...
		?>>
			...
			if (!empty($item['link']) && !empty($item['link_text'])) {
				?><a href="<?php echo esc_url($item['link']); ?>" class="sc_action_item_link sc_button_default2"><?php echo esc_html($item['link_text']); ?></a><?php
			}
			if (!empty($item['info'])) {
			...
			if (!empty($item['bg_image']) || !empty($item['bg_color'])) {
				...
				if (!empty($item['link']) && empty($item['link_text'])) {
					?><a href="<?php echo esc_url($item['link']); ?>" class="sc_action_item_link sc_action_item_link_over sc_button_default2"></a><?php
				}
			}
		?></div><?php
