      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
			...
			<tr>
				<td colspan="2">
				Please view the terms and conditions and print them for your records<br>
					http://healthycommunityliving.com/LWC-facilitator-training/content/terms-and-conditions
				</td>
			</tr>
