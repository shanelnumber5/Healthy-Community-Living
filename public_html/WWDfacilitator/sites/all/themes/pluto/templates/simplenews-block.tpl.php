...
<?php if ($use_form): ?>
  <?php
  $form['#prefix'] = '<section class="table-row">';
  $form['#suffix'] = '</section>';

  $form['submit']['#attributes']['class'][] = 'btn-primary';
  $form['submit']['#prefix'] = '<div class="table-cell">';
  $form['submit']['#suffix'] = '</div>';

  $form['mail']['#prefix'] = '<div class="table-cell">';
  $form['mail']['#suffix'] = '</div>';
  $form['mail']['#attributes']['placeholder'] = t('Your e-mail address');
